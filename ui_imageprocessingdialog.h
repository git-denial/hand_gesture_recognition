...
public:
    ...
    {
        ImageProcessingDialog->setWindowTitle(QApplication::translate("ImageProcessingDialog", "Dialog", 0));
        surfDetectorButton->setText(QApplication::translate("ImageProcessingDialog", "SURF", 0));
        siftDetectorButton->setText(QApplication::translate("ImageProcessingDialog", "SIFT", 0));
        harrisDetectorButton->setText(QApplication::translate("ImageProcessingDialog", "Harris Corner", 0));
        fastDetectorButton->setText(QApplication::translate("ImageProcessingDialog", "FAST", 0));
        tabWidget->setTabText(tabWidget->indexOf(detectorTab), QApplication::translate("ImageProcessingDialog", "Detector", 0));
        tabWidget->setTabText(tabWidget->indexOf(descriptorTab), QApplication::translate("ImageProcessingDialog", "Descriptor", 0));
        tabWidget->setTabText(tabWidget->indexOf(matcherTab), QApplication::translate("ImageProcessingDialog", "Matcher", 0));
    } // retranslateUi
